...
<?php 
  ...
  <table data-toggle="table" class="bg-light text-dark">
    ...
    ?>
    <tr><td>
    <a href="Tracks.php?id=<?= $ligne["id"] ?>&title=<?= $ligne["title"]?>&adaptation=<?= $ligne["adaptationName"]?>&genre=<?= $ligne["idGenre"]?>"><p><?= $ligne["title"]?>
        
        <?php
        if($ligne["adaptationName"] != "Original"){
            ?>
                (<?=$ligne["adaptationName"]?>)
        <?php
            } 
        ?>
